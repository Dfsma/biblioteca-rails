...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { idioma_id: @libro.idioma_id, nombre: @libro.nombre } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { idioma_id: @libro.idioma_id, nombre: @libro.nombre } }
